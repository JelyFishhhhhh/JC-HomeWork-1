                     ...
                     int multiplicandDegree, int multiplierDegree, int &productDegree )
{
    ...
    for (int ix = multiplicandDegree; ix >= 0; ix--) {

        for (int iy = multiplierDegree; iy >= 0; iy--) {
    ...
    int dividendDegree, int divisorDegree, int& quotientDegree, int& remainderDegree)
{
    ...
    for (int j={ quotientDegree }; j >= 0; j--)//modify
    {
        int buffer[200]={};
        int bufferDegree;
        int monomial[200]={};//add
        int monomialDegree= j;//add
        bufferDegree = monomialDegree + divisorDegree;

        monomial[j] = remainder[remainderDegree] / divisor[divisorDegree];//modify
        quotient[j] = monomial[j];//add
